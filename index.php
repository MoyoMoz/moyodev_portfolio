...
<html lang="en">
  <head>
    ...
    <!-- Google Fonts -->
    <link
    href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i|Fira+Mono:400,700"
    rel="stylesheet"
  />
    <!-- Vendor CSS Files -->
      ...
      <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            ...
            <div
              class="col-lg-8 pt-4 pt-lg-0 content intro-para about-aligned-text"
            >
              <h3>
                <!-- Why hire me to Code your project or work for your company? -->
              </h3>
              <p>
                <!-- Clear, honest communication and adding value to your project or
                company are the bedrocks of my professional ethos. <br />
                If confronted with an unfamiliar challenge, I relentlessly
                pursue solutions.<br /><br /> -->
                <!-- In 2022, I embarked on a coding
              journey, and it's crystal clear that this is the path I wish to
              tread for the foreseeable future. <br>
              Come August 2023, I wrapped up six intensive months of
                full-time, in-person, full-stack developer education at Ada
                Academy, a bootcamp renowned for its competitive yet
                collaborative spirit. <br />
                My learning doesn't halt there. Currently, I'm diving deep into
              ...
              <p>
                ...
                savoring the precision demanded in chef-driven kitchens — my
                journey has been multifaceted and enlightening. My
                two-decade-long yoga practice ensures I remain grounded and
                heart-centered. -->
              </p>
            </div>
          </div></div>
